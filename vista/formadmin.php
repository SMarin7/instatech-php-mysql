      ...
      <div id="my_slider" class="carousel slide" data-ride="carousel">
         <div class="carousel-inner">
            <div class="carousel-item active">
               <div class="container">
                  <h1 class="client_taital">Cuenta de Administrador</h1>
                  <div class="client_section_2">
                     <div class="client_left">
                     <div onclick="location.href='../vista/formadmin.php';" class="box_main active"  >
                     <div class="icon_1"><img style="width: 60%; " src="../images/adminpng.png"></div>
                     <h4 class="daily_text_1">Cuenta de Administrador</h4>
                  </div>
                     </div>
                     <div class="client_right1">
                     <p class="client_textit"><br><br><br><br><br>Inicia sesión en nuestro <br> sistema como administrador para <br> hacer usos de los privilegios de este mismo.</p>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="ffsi">
        <div class="box">
            <div class="form sign_in">
                <h3>Inicia sesión <br> como administrador</h3>
                <span>Usa tu cuenta ya creada</span>
                

                <form action="../vista/vistaAdmin/tablas.php" method="post" id="form_input">
        ...
        <div class="overlay">
            <div class="page page_signIn">
                <h3>Bienvenido de nuevo <br> Administrador!</h3>
                <p>Para continuar, inicia sesión con el usuario y contraseña de administrador</p>
