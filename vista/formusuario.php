                     ...
                     <li class="open_submenu">
                        ...
                        <div class="submenu">
                           <ul>
                              ...
                              <li><a id="mpv" href="../vista/formadmin.php">Cuenta de Administrador</a></li>
                           </ul>
                        </div>
                     </li>
                  </ul>
      ...
      <div id="my_slider" class="carousel slide" data-ride="carousel">
         <div class="carousel-inner">
            <div class="carousel-item active">
               <div class="container">
                  <h1 class="client_taital">Cuenta de Cliente</h1>
                  <div class="client_section_2">
                     <div class="client_left">
                     <div onclick="location.href='../vista/formusuario.php';" class="box_main active"  >
                     <!-- PENDIENTE QUEDA EL TAMAÑO DEL CUADRO -->
                     <div class="icon_1"><img style="width: 50%; " src="../images/clien.png"></div>
                     <h4 class="daily_text_1">Cuenta de Cliente</h4>
                  </div>
                     </div>
                     <div class="client_right1">
                     <p class="client_textit">Con la cuenta de clientes tienes la posibilidad de ver la gran <br><br>variedad de nuestro catálogo sin restricciones, puedes añadir <br><br>los productos que deseas comprar en el carrito de compras <br><br> y puedes pedir que un técnico te haga la instalación de los <br><br> productos que compres por un pequeño valor adicional a la <br><br> compra. Disfruta.</p>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="ffsi">
        <div class="box">
            <div class="form sign_in">
                <h3>Inicia sesión <br> como cliente</h3>
                <span>usa tu cuenta ya creada</span>
                

                <form action="../controlador/iniciarSesionC.php" method="post" id="form_input">
            ...
            <div class="form sign_up">
                ...
                <form action="../controlador/registroC.php" method="post" id="form_input">
